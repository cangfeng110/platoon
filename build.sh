...
cd build/
rm -r *
cmake -Dpegasus-build=ON -DCMAKE_TOOLCHAIN_FILE=/home/igs/zsworkspace/Ysg/atd-master/cmake/Toolchain-V5L.cmake -DVIBRANTE_PDK:STRING=/home/igs/zsworkspace/atd_environment/nvidia/nvidia_sdk/DRIVE/Linux/5.0.13.2/SW/DriveSDK/drive-t186ref-linux ..
