...
#include "modules/ipc/message/protobuf/common/configs/vehicle_config.pb.h"
#include "modules/common/include/macro.h"

/**
 * @namespace atd::worldmodel::config
 * @brief atd::worldmodel::config
 */
namespace atd {
 ...
 * defined modules/worldmodel/configs/proto/vehicle_config.proto
 */
class VehicleConfigHelper {
 public:
  /**
   ...
   * defined by modules/worldmodel/configs/proto/vehicle_config.proto.
   */
   ...
   * modules/worldmodel/configs/proto/vehicle_config.proto.
   */
