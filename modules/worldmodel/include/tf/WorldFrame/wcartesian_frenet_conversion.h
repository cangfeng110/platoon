#ifndef MODULES_TF_WORLD_FRAME_CONVERSION_WCARTESIAN_FRENET_CONVERSION_H_
#define MODULES_TF_WORLD_FRAME_CONVERSION_WCARTESIAN_FRENET_CONVERSION_H_
...
// l: the same as d.
class WcartesianFrenetConverter {
 public:
  WcartesianFrenetConverter() = delete;
  /**
  ...
  static math::Vec2d CalculateCartesianPoint(
...
#endif  // MODULES_TF_WORLD_FRAME_CONVERSION_WCARTESIAN_FRENET_CONVERSION_H_
