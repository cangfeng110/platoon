#include "modules/worldmodel/include/math/polygon2d.h"
...
std::string Polygon2d::DebugString() const {
  return atd::common::util::StrCat("polygon2d (  num_points = ", num_points_, "  points = (",
                      atd::common::util::PrintDebugStringIter(points_), " )  ",
