...
////=======================================================================================
//const std::string CHANNEL_NAME_MWR_RAW_FRONT_S="MWR_RAW_FRONT_OBJECTS";
...
//const std::string CHANNEL_NAME_CANET_MWR_FRONT_FSDA2IPC="MWR_RAW_FRONT_FSDA_OBJECTS";
...
////EP21
////=========================================================================================
//const std::string CHANNEL_NAME_RDA_OBJECTS = "RDA_MWR_RAW_OBJECT";
//const std::string CHANNEL_NAME_FSDA_OBJECTS = "FSDA_MWR_RAW_OBJECT";
//const std::string CHANNEL_NAME_BOSCH_OBJECTS = "BOSCH_MWR_RAW_OBJECT";
...
////SV51
////=========================================================================================
//const std::string CHANNEL_NAME_SV51Front_OBJECTS = "MWR_RAW_OBJECT_Front";
//const std::string CHANNEL_NAME_SV51FrontLeft_OBJECTS = "MWR_RAW_OBJECT_Front_Left";
//const std::string CHANNEL_NAME_SV51FrontRight_OBJECTS = "MWR_RAW_OBJECT_Front_Right";
//const std::string CHANNEL_NAME_SV51RearLeft_OBJECTS = "MWR_RAW_OBJECT_Rear_Left";
//const std::string CHANNEL_NAME_SV51RearRight_OBJECTS = "MWR_RAW_OBJECT_Rear_Right";


////=========================================================================================

const std::string CHANNEL_NAME_LOGITECH_IMAGE="LOGITECH_IMAGE";
const std::string CHANNEL_NAME_BREAKTHROUGH_MSG="BREAKTHROUGH";//for test pathplan
const std::string CHANNEL_NAME_CAN_MSG="CAN";
const std::string CHANNEL_NAME_CONTROL_CMD="CONTROL_CMD";
const std::string CHANNEL_NAME_PIKE_IMAGE="PIKE_IMAGE";
...
const std::string CHANNEL_NAME_INS300C58="INS300C58";
const std::string CHANNEL_NAME_INS300C="INS300C";
const std::string CHANNEL_NAME_OWNSINS="OWNSINS";
...
const std::string CHANNEL_NAME_DRIVER_MAP_TSR_DISTANCE = "DRIVER_MAP_TSR_DISTANCE";
const std::string CHANNEL_NAME_DRIVER_MAP_CHAIN_FURNITURE = "DRIVER_CHAIN_FURNITURE";
const std::string CHANNEL_NAME_DRIVER_MAP_ONE_PARKING_SITE = "DRIVER_MAP_ONE_PARKING_SITE";
