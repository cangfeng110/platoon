...
#ifndef __UBLOX_hpp__
#define __UBLOX_hpp__
...
int UBLOX::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int UBLOX::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int UBLOX::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t UBLOX::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* UBLOX::getTypeName()
{
    return "UBLOX";
}

int UBLOX::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int UBLOX::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int UBLOX::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t UBLOX::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == UBLOX::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)UBLOX::getHash };
