...
#ifndef __MWR_RIGHT_RAW_OBJECTS_hpp__
#define __MWR_RIGHT_RAW_OBJECTS_hpp__

#include "HEADER.hpp"


class MWR_RIGHT_RAW_OBJECTS
{
    public:
        HEADER     header;
...
int MWR_RIGHT_RAW_OBJECTS::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MWR_RIGHT_RAW_OBJECTS::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int MWR_RIGHT_RAW_OBJECTS::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t MWR_RIGHT_RAW_OBJECTS::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* MWR_RIGHT_RAW_OBJECTS::getTypeName()
{
    return "MWR_RIGHT_RAW_OBJECTS";
}

int MWR_RIGHT_RAW_OBJECTS::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MWR_RIGHT_RAW_OBJECTS::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int MWR_RIGHT_RAW_OBJECTS::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t MWR_RIGHT_RAW_OBJECTS::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == MWR_RIGHT_RAW_OBJECTS::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)MWR_RIGHT_RAW_OBJECTS::getHash };
