...
#ifndef __GPS982_hpp__
#define __GPS982_hpp__
...
int GPS982::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int GPS982::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int GPS982::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t GPS982::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* GPS982::getTypeName()
{
    return "GPS982";
}

int GPS982::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int GPS982::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int GPS982::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t GPS982::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == GPS982::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)GPS982::getHash };

    uint64_t hash = 0xe5cfb24572f2af4dLL +
