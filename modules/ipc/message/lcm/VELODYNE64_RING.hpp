...
#ifndef __VELODYNE64_RING_hpp__
#define __VELODYNE64_RING_hpp__



class VELODYNE64_RING
{
    public:
...
int VELODYNE64_RING::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int VELODYNE64_RING::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int VELODYNE64_RING::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t VELODYNE64_RING::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* VELODYNE64_RING::getTypeName()
{
    return "VELODYNE64_RING";
}

int VELODYNE64_RING::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int VELODYNE64_RING::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int VELODYNE64_RING::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t VELODYNE64_RING::_computeHash(const __lcm_hash_ptr *)
{
