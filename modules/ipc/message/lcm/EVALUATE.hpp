...
int EVALUATE::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int EVALUATE::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int EVALUATE::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t EVALUATE::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* EVALUATE::getTypeName()
{
    return "EVALUATE";
}

int EVALUATE::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int EVALUATE::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int EVALUATE::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t EVALUATE::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xd8586b423656ea8eLL;
