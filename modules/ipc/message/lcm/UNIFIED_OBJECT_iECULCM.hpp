...
#ifndef __UNIFIED_OBJECT_iECULCM_hpp__
#define __UNIFIED_OBJECT_iECULCM_hpp__

#include "TRACK_STATUS_iECULCM.hpp"


class UNIFIED_OBJECT_iECULCM
{
    public:
        int16_t    nObjectID;
        ...
        TRACK_STATUS_iECULCM gstSenserTracked[3];
    ...
    public:
        ...
        /**
         * Returns "UNIFIED_OBJECT_iECULCM"
         */
...
int UNIFIED_OBJECT_iECULCM::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int UNIFIED_OBJECT_iECULCM::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int UNIFIED_OBJECT_iECULCM::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t UNIFIED_OBJECT_iECULCM::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* UNIFIED_OBJECT_iECULCM::getTypeName()
{
    return "UNIFIED_OBJECT_iECULCM";
}

int UNIFIED_OBJECT_iECULCM::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int UNIFIED_OBJECT_iECULCM::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int UNIFIED_OBJECT_iECULCM::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t UNIFIED_OBJECT_iECULCM::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == UNIFIED_OBJECT_iECULCM::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)UNIFIED_OBJECT_iECULCM::getHash };

    uint64_t hash = 0xddbbf7f4bc93e94eLL +
         TRACK_STATUS_iECULCM::_computeHash(&cp);
