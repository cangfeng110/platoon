...
#ifndef __DRIVER_MAP_ONE_PARKING_SITE_hpp__
#define __DRIVER_MAP_ONE_PARKING_SITE_hpp__
...
class DRIVER_MAP_ONE_PARKING_SITE
{
    public:
        HEADER     stHeader;
    ...
    public:
        ...
        /**
         * Returns "DRIVER_MAP_ONE_PARKING_SITE"
         */
...
int DRIVER_MAP_ONE_PARKING_SITE::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int DRIVER_MAP_ONE_PARKING_SITE::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int DRIVER_MAP_ONE_PARKING_SITE::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t DRIVER_MAP_ONE_PARKING_SITE::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* DRIVER_MAP_ONE_PARKING_SITE::getTypeName()
{
    return "DRIVER_MAP_ONE_PARKING_SITE";
}

int DRIVER_MAP_ONE_PARKING_SITE::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->iAppStatus, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &this->iAdd, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int DRIVER_MAP_ONE_PARKING_SITE::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->iAppStatus, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int64_t_decode_array(buf, offset + pos, maxlen - pos, &this->iAdd, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int DRIVER_MAP_ONE_PARKING_SITE::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t DRIVER_MAP_ONE_PARKING_SITE::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == DRIVER_MAP_ONE_PARKING_SITE::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)DRIVER_MAP_ONE_PARKING_SITE::getHash };

    uint64_t hash = 0x207690d2a3ab1636LL +
