...
#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fvehicle_5fstate_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fvehicle_5fstate_2eproto__INCLUDED
...
class VehicleState : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.VehicleState) */ {
 public:
  VehicleState();
  ...
  ::atd::canbus::Chassis_GearPosition gear() const;
  void set_gear(::atd::canbus::Chassis_GearPosition value);
  ...
  // @@protoc_insertion_point(class_scope:atd.common.VehicleState)
 private:
  void set_has_x();
  void clear_has_x();
  void set_has_y();
  ...
  int gear_;
  int driving_mode_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fvehicle_5fstate_2eproto::TableStruct;
};
// ===================================================================
...
inline ::atd::canbus::Chassis_GearPosition VehicleState::gear() const {
  // @@protoc_insertion_point(field_get:atd.common.VehicleState.gear)
  return static_cast< ::atd::canbus::Chassis_GearPosition >(gear_);
}
inline void VehicleState::set_gear(::atd::canbus::Chassis_GearPosition value) {
...
inline ::atd::canbus::Chassis_DrivingMode VehicleState::driving_mode() const {
...
inline void VehicleState::set_driving_mode(::atd::canbus::Chassis_DrivingMode value) {
...
inline const ::atd::localization::Pose& VehicleState::pose() const {
...
inline ::atd::localization::Pose* VehicleState::mutable_pose() {
  set_has_pose();
  if (pose_ == NULL) {
...
inline ::atd::localization::Pose* VehicleState::release_pose() {
...
inline void VehicleState::set_allocated_pose(::atd::localization::Pose* pose) {
  delete pose_;
  pose_ = pose;
  if (pose) {
    set_has_pose();
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fvehicle_5fstate_2eproto__INCLUDED
