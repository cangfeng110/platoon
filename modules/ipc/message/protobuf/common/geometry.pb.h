...
#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fgeometry_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fgeometry_2eproto__INCLUDED
...
class PointENU : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.PointENU) */ {
 public:
  PointENU();
  virtual ~PointENU();
 ...
 private:
  ...
  double x_;
  double y_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fgeometry_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class PointLLH : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.PointLLH) */ {
 public:
  PointLLH();
  virtual ~PointLLH();
...
class Point2D : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.Point2D) */ {
 public:
  Point2D();
  virtual ~Point2D();
...
class Arrow2D : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.Arrow2D) */ {
 public:
  Arrow2D();
  virtual ~Arrow2D();

  Arrow2D(const Arrow2D& from);

  inline Arrow2D& operator=(const Arrow2D& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const Arrow2D& default_instance();

  static inline const Arrow2D* internal_default_instance() {
    return reinterpret_cast<const Arrow2D*>(
               &_Arrow2D_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    3;

  void Swap(Arrow2D* other);

  // implements Message ----------------------------------------------

  inline Arrow2D* New() const PROTOBUF_FINAL { return New(NULL); }

  Arrow2D* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
  void CopyFrom(const Arrow2D& from);
  void MergeFrom(const Arrow2D& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(Arrow2D* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
...
class Point3D : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.Point3D) */ {
 public:
  Point3D();
  virtual ~Point3D();
...
class Quaternion : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.Quaternion) */ {
 public:
  Quaternion();
  virtual ~Quaternion();
...
// optional double x = 1 [default = nan];
inline bool Arrow2D::has_x() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Arrow2D::set_has_x() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Arrow2D::clear_has_x() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Arrow2D::clear_x() {
  x_ = ::google::protobuf::internal::NaN();
  clear_has_x();
}
inline double Arrow2D::x() const {
  // @@protoc_insertion_point(field_get:atd.common.Arrow2D.x)
  return x_;
}
inline void Arrow2D::set_x(double value) {
  set_has_x();
  x_ = value;
...
// optional double y = 2 [default = nan];
inline bool Arrow2D::has_y() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Arrow2D::set_has_y() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Arrow2D::clear_has_y() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Arrow2D::clear_y() {
  y_ = ::google::protobuf::internal::NaN();
  clear_has_y();
}
inline double Arrow2D::y() const {
  // @@protoc_insertion_point(field_get:atd.common.Arrow2D.y)
  return y_;
}
inline void Arrow2D::set_y(double value) {
  set_has_y();
  y_ = value;
...
// optional double yaw = 3 [default = nan];
inline bool Arrow2D::has_yaw() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Arrow2D::set_has_yaw() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Arrow2D::clear_has_yaw() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Arrow2D::clear_yaw() {
  yaw_ = ::google::protobuf::internal::NaN();
  clear_has_yaw();
}
inline double Arrow2D::yaw() const {
  // @@protoc_insertion_point(field_get:atd.common.Arrow2D.yaw)
  return yaw_;
}
inline void Arrow2D::set_yaw(double value) {
  set_has_yaw();
  yaw_ = value;
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fgeometry_2eproto__INCLUDED
