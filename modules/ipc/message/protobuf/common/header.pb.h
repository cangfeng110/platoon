...
#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fheader_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fheader_2eproto__INCLUDED
...
class Header : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.common.Header) */ {
 public:
  Header();
  virtual ~Header();
  ...
  const ::atd::common::StatusPb& status() const;
  ::atd::common::StatusPb* mutable_status();
  ::atd::common::StatusPb* release_status();
  void set_allocated_status(::atd::common::StatusPb* status);
 ...
 private:
  ...
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fheader_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::atd::common::StatusPb& Header::status() const {
...
inline ::atd::common::StatusPb* Header::mutable_status() {
  set_has_status();
  if (status_ == NULL) {
...
inline ::atd::common::StatusPb* Header::release_status() {
...
inline void Header::set_allocated_status(::atd::common::StatusPb* status) {
  delete status_;
  status_ = status;
  if (status) {
    set_has_status();
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcommon_2fheader_2eproto__INCLUDED
