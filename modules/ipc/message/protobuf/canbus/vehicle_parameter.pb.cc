...
#include "modules/ipc/message/protobuf/canbus/vehicle_parameter.pb.h"
...
VehicleParameter::VehicleParameter()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fipc_2fmessage_2fprotobuf_2fcanbus_2fvehicle_5fparameter_2eproto::InitDefaults();
  }
  SharedCtor();
