...
// source: modules/ipc/message/protobuf/canbus/canbus_conf.proto

#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcanbus_2fcanbus_5fconf_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcanbus_2fcanbus_5fconf_2eproto__INCLUDED
...
namespace protobuf_modules_2fipc_2fmessage_2fprotobuf_2fcanbus_2fcanbus_5fconf_2eproto {
...
class CanbusConf : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.canbus.CanbusConf) */ {
 public:
  CanbusConf();
  virtual ~CanbusConf();
  ...
  const ::atd::canbus::VehicleParameter& vehicle_parameter() const;
  ::atd::canbus::VehicleParameter* mutable_vehicle_parameter();
  ::atd::canbus::VehicleParameter* release_vehicle_parameter();
  void set_allocated_vehicle_parameter(::atd::canbus::VehicleParameter* vehicle_parameter);
  ...
  // @@protoc_insertion_point(class_scope:atd.canbus.CanbusConf)
 private:
  ...
  ::atd::canbus::VehicleParameter* vehicle_parameter_;
  bool enable_debug_mode_;
  bool enable_receiver_log_;
  bool enable_sender_log_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fcanbus_2fcanbus_5fconf_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::atd::canbus::VehicleParameter& CanbusConf::vehicle_parameter() const {
...
inline ::atd::canbus::VehicleParameter* CanbusConf::mutable_vehicle_parameter() {
...
inline ::atd::canbus::VehicleParameter* CanbusConf::release_vehicle_parameter() {
...
inline void CanbusConf::set_allocated_vehicle_parameter(::atd::canbus::VehicleParameter* vehicle_parameter) {
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fcanbus_2fcanbus_5fconf_2eproto__INCLUDED
