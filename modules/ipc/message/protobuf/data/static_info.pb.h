...
#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fdata_2fstatic_5finfo_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fdata_2fstatic_5finfo_2eproto__INCLUDED
...
#include "modules/ipc/message/protobuf/canbus/canbus_conf.pb.h"
...
class VehicleInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.VehicleInfo) */ {
 public:
  VehicleInfo();
  virtual ~VehicleInfo();
  ...
  const ::atd::canbus::CanbusConf& canbus_conf() const;
  ::atd::canbus::CanbusConf* mutable_canbus_conf();
  ::atd::canbus::CanbusConf* release_canbus_conf();
  void set_allocated_canbus_conf(::atd::canbus::CanbusConf* canbus_conf);
  ...
  const ::atd::common::VehicleConfig& vehicle_config() const;
  ::atd::common::VehicleConfig* mutable_vehicle_config();
  ::atd::common::VehicleConfig* release_vehicle_config();
  void set_allocated_vehicle_config(::atd::common::VehicleConfig* vehicle_config);

  // optional .atd.data.VehicleInfo.Brand brand = 2;
  bool has_brand() const;
  void clear_brand();
  static const int kBrandFieldNumber = 2;
  ::atd::data::VehicleInfo_Brand brand() const;
  void set_brand(::atd::data::VehicleInfo_Brand value);

  // optional .atd.data.VehicleInfo.Model model = 3;
  bool has_model() const;
  void clear_model();
  static const int kModelFieldNumber = 3;
  ::atd::data::VehicleInfo_Model model() const;
  void set_model(::atd::data::VehicleInfo_Model value);

  // @@protoc_insertion_point(class_scope:atd.data.VehicleInfo)
 private:
  void set_has_name();
  void clear_has_name();
  void set_has_brand();
  ...
  ::atd::canbus::CanbusConf* canbus_conf_;
  ::atd::common::VehicleConfig* vehicle_config_;
  int brand_;
  int model_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fdata_2fstatic_5finfo_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class EnvironmentInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.EnvironmentInfo) */ {
 public:
  EnvironmentInfo();
  ...
  // @@protoc_insertion_point(class_scope:atd.data.EnvironmentInfo)
 private:
...
class HardwareInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.HardwareInfo) */ {
 public:
  HardwareInfo();
  ...
  // @@protoc_insertion_point(class_scope:atd.data.HardwareInfo)
 private:
...
class SoftwareInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.SoftwareInfo) */ {
 public:
  SoftwareInfo();
  ...
  // @@protoc_insertion_point(class_scope:atd.data.SoftwareInfo)
 private:
...
class UserInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.UserInfo) */ {
 public:
  UserInfo();
  virtual ~UserInfo();
  ...
  // @@protoc_insertion_point(class_scope:atd.data.UserInfo)
 private:
  void set_has_entity();
...
class StaticInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.StaticInfo) */ {
 public:
  StaticInfo();
  virtual ~StaticInfo();
  ...
  const ::atd::data::VehicleInfo& vehicle() const;
  ::atd::data::VehicleInfo* mutable_vehicle();
  ::atd::data::VehicleInfo* release_vehicle();
  void set_allocated_vehicle(::atd::data::VehicleInfo* vehicle);

  // optional .atd.data.EnvironmentInfo environment = 2;
  bool has_environment() const;
  void clear_environment();
  static const int kEnvironmentFieldNumber = 2;
  const ::atd::data::EnvironmentInfo& environment() const;
  ::atd::data::EnvironmentInfo* mutable_environment();
  ::atd::data::EnvironmentInfo* release_environment();
  void set_allocated_environment(::atd::data::EnvironmentInfo* environment);

  // optional .atd.data.HardwareInfo hardware = 3;
  bool has_hardware() const;
  void clear_hardware();
  static const int kHardwareFieldNumber = 3;
  const ::atd::data::HardwareInfo& hardware() const;
  ::atd::data::HardwareInfo* mutable_hardware();
  ::atd::data::HardwareInfo* release_hardware();
  void set_allocated_hardware(::atd::data::HardwareInfo* hardware);

  // optional .atd.data.SoftwareInfo software = 4;
  bool has_software() const;
  void clear_software();
  static const int kSoftwareFieldNumber = 4;
  const ::atd::data::SoftwareInfo& software() const;
  ::atd::data::SoftwareInfo* mutable_software();
  ::atd::data::SoftwareInfo* release_software();
  void set_allocated_software(::atd::data::SoftwareInfo* software);

  // optional .atd.data.UserInfo user = 5;
  bool has_user() const;
  void clear_user();
  static const int kUserFieldNumber = 5;
  const ::atd::data::UserInfo& user() const;
  ::atd::data::UserInfo* mutable_user();
  ::atd::data::UserInfo* release_user();
  void set_allocated_user(::atd::data::UserInfo* user);

  // @@protoc_insertion_point(class_scope:atd.data.StaticInfo)
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::atd::data::VehicleInfo* vehicle_;
  ::atd::data::EnvironmentInfo* environment_;
  ::atd::data::HardwareInfo* hardware_;
  ::atd::data::SoftwareInfo* software_;
  ::atd::data::UserInfo* user_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fdata_2fstatic_5finfo_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class StaticInfoConf : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.data.StaticInfoConf) */ {
 public:
  StaticInfoConf();
  ...
  // @@protoc_insertion_point(class_scope:atd.data.StaticInfoConf)
 private:
...
inline ::atd::data::VehicleInfo_Brand VehicleInfo::brand() const {
  // @@protoc_insertion_point(field_get:atd.data.VehicleInfo.brand)
  return static_cast< ::atd::data::VehicleInfo_Brand >(brand_);
}
inline void VehicleInfo::set_brand(::atd::data::VehicleInfo_Brand value) {
...
inline ::atd::data::VehicleInfo_Model VehicleInfo::model() const {
  // @@protoc_insertion_point(field_get:atd.data.VehicleInfo.model)
  return static_cast< ::atd::data::VehicleInfo_Model >(model_);
}
inline void VehicleInfo::set_model(::atd::data::VehicleInfo_Model value) {
...
inline const ::atd::canbus::License& VehicleInfo::license() const {
...
inline ::atd::canbus::License* VehicleInfo::mutable_license() {
  set_has_license();
  if (license_ == NULL) {
...
inline ::atd::canbus::License* VehicleInfo::release_license() {
...
inline void VehicleInfo::set_allocated_license(::atd::canbus::License* license) {
  delete license_;
  license_ = license;
  if (license) {
    set_has_license();
...
inline const ::atd::canbus::CanbusConf& VehicleInfo::canbus_conf() const {
...
inline ::atd::canbus::CanbusConf* VehicleInfo::mutable_canbus_conf() {
  set_has_canbus_conf();
...
inline ::atd::canbus::CanbusConf* VehicleInfo::release_canbus_conf() {
...
inline void VehicleInfo::set_allocated_canbus_conf(::atd::canbus::CanbusConf* canbus_conf) {
  delete canbus_conf_;
...
inline const ::atd::common::VehicleConfig& VehicleInfo::vehicle_config() const {
...
inline ::atd::common::VehicleConfig* VehicleInfo::mutable_vehicle_config() {
...
inline ::atd::common::VehicleConfig* VehicleInfo::release_vehicle_config() {
...
inline void VehicleInfo::set_allocated_vehicle_config(::atd::common::VehicleConfig* vehicle_config) {
...
inline const ::atd::data::VehicleInfo& StaticInfo::vehicle() const {
...
inline ::atd::data::VehicleInfo* StaticInfo::mutable_vehicle() {
  set_has_vehicle();
  if (vehicle_ == NULL) {
...
inline ::atd::data::VehicleInfo* StaticInfo::release_vehicle() {
...
inline void StaticInfo::set_allocated_vehicle(::atd::data::VehicleInfo* vehicle) {
  delete vehicle_;
  vehicle_ = vehicle;
  if (vehicle) {
    set_has_vehicle();
...
inline const ::atd::data::EnvironmentInfo& StaticInfo::environment() const {
...
inline ::atd::data::EnvironmentInfo* StaticInfo::mutable_environment() {
  set_has_environment();
...
inline ::atd::data::EnvironmentInfo* StaticInfo::release_environment() {
...
inline void StaticInfo::set_allocated_environment(::atd::data::EnvironmentInfo* environment) {
  delete environment_;
...
inline const ::atd::data::HardwareInfo& StaticInfo::hardware() const {
...
inline ::atd::data::HardwareInfo* StaticInfo::mutable_hardware() {
  set_has_hardware();
  if (hardware_ == NULL) {
...
inline ::atd::data::HardwareInfo* StaticInfo::release_hardware() {
...
inline void StaticInfo::set_allocated_hardware(::atd::data::HardwareInfo* hardware) {
  delete hardware_;
  hardware_ = hardware;
  if (hardware) {
    set_has_hardware();
...
inline const ::atd::data::SoftwareInfo& StaticInfo::software() const {
...
inline ::atd::data::SoftwareInfo* StaticInfo::mutable_software() {
  set_has_software();
  if (software_ == NULL) {
...
inline ::atd::data::SoftwareInfo* StaticInfo::release_software() {
...
inline void StaticInfo::set_allocated_software(::atd::data::SoftwareInfo* software) {
  delete software_;
  software_ = software;
  if (software) {
    set_has_software();
...
inline const ::atd::data::UserInfo& StaticInfo::user() const {
...
inline ::atd::data::UserInfo* StaticInfo::mutable_user() {
  set_has_user();
  if (user_ == NULL) {
...
inline ::atd::data::UserInfo* StaticInfo::release_user() {
...
inline void StaticInfo::set_allocated_user(::atd::data::UserInfo* user) {
  delete user_;
  user_ = user;
  if (user) {
    set_has_user();
...
template <> struct is_proto_enum< ::atd::data::VehicleInfo_Brand> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::atd::data::VehicleInfo_Model> : ::google::protobuf::internal::true_type {};
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fdata_2fstatic_5finfo_2eproto__INCLUDED
