...
#include "modules/ipc/message/protobuf/drivers/canbus/chassis.pb.h"
...
Chassis::Chassis()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fchassis_2eproto::InitDefaults();
  }
  SharedCtor();
