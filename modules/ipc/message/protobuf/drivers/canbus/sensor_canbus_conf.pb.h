...
#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fsensor_5fcanbus_5fconf_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fsensor_5fcanbus_5fconf_2eproto__INCLUDED
...
class SensorCanbusConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:atd.drivers.canbus.SensorCanbusConf) */ {
 public:
  SensorCanbusConf();
  ...
  const ::atd::drivers::canbus::CANCardParameter& can_card_parameter() const;
  ::atd::drivers::canbus::CANCardParameter* mutable_can_card_parameter();
  ::atd::drivers::canbus::CANCardParameter* release_can_card_parameter();
  void set_allocated_can_card_parameter(::atd::drivers::canbus::CANCardParameter* can_card_parameter);
  ...
  // @@protoc_insertion_point(class_scope:atd.drivers.canbus.SensorCanbusConf)
 private:
  ...
  ::atd::drivers::canbus::CANCardParameter* can_card_parameter_;
  bool enable_debug_mode_;
  bool enable_receiver_log_;
  bool enable_sender_log_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fsensor_5fcanbus_5fconf_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::atd::drivers::canbus::CANCardParameter& SensorCanbusConf::can_card_parameter() const {
...
inline ::atd::drivers::canbus::CANCardParameter* SensorCanbusConf::mutable_can_card_parameter() {
...
inline ::atd::drivers::canbus::CANCardParameter* SensorCanbusConf::release_can_card_parameter() {
...
inline void SensorCanbusConf::set_allocated_can_card_parameter(::atd::drivers::canbus::CANCardParameter* can_card_parameter) {
...
// optional bool enable_sender_log = 4 [default = false];
inline bool SensorCanbusConf::has_enable_sender_log() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void SensorCanbusConf::set_has_enable_sender_log() {
  _has_bits_[0] |= 0x00000008u;
}
inline void SensorCanbusConf::clear_has_enable_sender_log() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void SensorCanbusConf::clear_enable_sender_log() {
  enable_sender_log_ = false;
  clear_has_enable_sender_log();
}
inline bool SensorCanbusConf::enable_sender_log() const {
  // @@protoc_insertion_point(field_get:atd.drivers.canbus.SensorCanbusConf.enable_sender_log)
  return enable_sender_log_;
}
inline void SensorCanbusConf::set_enable_sender_log(bool value) {
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fsensor_5fcanbus_5fconf_2eproto__INCLUDED
