...
// source: modules/ipc/message/protobuf/drivers/canbus/vehicle_parameter.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "modules/ipc/message/protobuf/drivers/canbus/vehicle_parameter.pb.h"
...
namespace protobuf_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fvehicle_5fparameter_2eproto {
...
VehicleParameter::VehicleParameter()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_modules_2fipc_2fmessage_2fprotobuf_2fdrivers_2fcanbus_2fvehicle_5fparameter_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:atd.canbus.VehicleParameter)
}
VehicleParameter::VehicleParameter(const VehicleParameter& from)
  ...
  // @@protoc_insertion_point(copy_constructor:atd.canbus.VehicleParameter)
}
...
VehicleParameter::~VehicleParameter() {
  // @@protoc_insertion_point(destructor:atd.canbus.VehicleParameter)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:atd.canbus.VehicleParameter)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:atd.canbus.VehicleParameter)
  for (;;) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::atd::canbus::VehicleParameter_VehicleBrand_IsValid(value)) {
            set_brand(static_cast< ::atd::canbus::VehicleParameter_VehicleBrand >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:atd.canbus.VehicleParameter)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:atd.canbus.VehicleParameter)
  return false;
#undef DO_
}
...
void VehicleParameter::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:atd.canbus.VehicleParameter)
  ...
  // @@protoc_insertion_point(serialize_end:atd.canbus.VehicleParameter)
}

size_t VehicleParameter::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:atd.canbus.VehicleParameter)
  size_t total_size = 0;
...
void VehicleParameter::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const VehicleParameter*>(&from));
}

void VehicleParameter::MergeFrom(const VehicleParameter& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:atd.canbus.VehicleParameter)
...
// @@protoc_insertion_point(class_specific_copy_from_start:atd.canbus.VehicleParameter)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string VehicleParameter::GetTypeName() const {
  return "atd.canbus.VehicleParameter";
}
...
::atd::canbus::VehicleParameter_VehicleBrand VehicleParameter::brand() const {
...
void VehicleParameter::set_brand(::atd::canbus::VehicleParameter_VehicleBrand value) {
...
::atd::canbus::Chassis_DrivingMode VehicleParameter::driving_mode() const {
...
void VehicleParameter::set_driving_mode(::atd::canbus::Chassis_DrivingMode value) {
