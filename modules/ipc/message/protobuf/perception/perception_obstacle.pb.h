...
#ifndef PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fperception_2fperception_5fobstacle_2eproto__INCLUDED
#define PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fperception_2fperception_5fobstacle_2eproto__INCLUDED
...
class Point : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.perception.Point) */ {
 public:
  Point();
  virtual ~Point();
  ...
  // @@protoc_insertion_point(class_scope:atd.perception.Point)
 private:
  void set_has_x();
  void clear_has_x();
  void set_has_y();
  ...
  double y_;
  double z_;
  friend struct protobuf_modules_2fipc_2fmessage_2fprotobuf_2fperception_2fperception_5fobstacle_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class PerceptionObstacle : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.perception.PerceptionObstacle) */ {
 public:
  PerceptionObstacle();
  ...
  const ::atd::perception::Point& polygon_point(int index) const;
  ::atd::perception::Point* mutable_polygon_point(int index);
  ::atd::perception::Point* add_polygon_point();
  ...
  const ::atd::perception::Point& position() const;
  ::atd::perception::Point* mutable_position();
  ::atd::perception::Point* release_position();
  void set_allocated_position(::atd::perception::Point* position);

  // optional .atd.perception.Point velocity = 4;
  bool has_velocity() const;
  void clear_velocity();
  static const int kVelocityFieldNumber = 4;
  const ::atd::perception::Point& velocity() const;
  ::atd::perception::Point* mutable_velocity();
  ::atd::perception::Point* release_velocity();
  void set_allocated_velocity(::atd::perception::Point* velocity);
  ...
  ::atd::perception::PerceptionObstacle_Type type() const;
  void set_type(::atd::perception::PerceptionObstacle_Type value);
  ...
  ::atd::perception::PerceptionObstacle_ConfidenceType confidence_type() const;
  void set_confidence_type(::atd::perception::PerceptionObstacle_ConfidenceType value);
  ...
  // @@protoc_insertion_point(class_scope:atd.perception.PerceptionObstacle)
 private:
  void set_has_id();
  void clear_has_id();
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::atd::perception::Point > polygon_point_;
  ::google::protobuf::RepeatedField< double > point_cloud_;
  mutable int _point_cloud_cached_byte_size_;
  ::atd::perception::Point* position_;
  ::atd::perception::Point* velocity_;
  double theta_;
  double length_;
...
class PerceptionObstacles : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:atd.perception.PerceptionObstacles) */ {
 public:
  PerceptionObstacles();
  ...
  const ::atd::perception::PerceptionObstacle& perception_obstacle(int index) const;
  ::atd::perception::PerceptionObstacle* mutable_perception_obstacle(int index);
  ::atd::perception::PerceptionObstacle* add_perception_obstacle();
  ...
  // @@protoc_insertion_point(class_scope:atd.perception.PerceptionObstacles)
 private:
  void set_has_header();
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::atd::perception::PerceptionObstacle > perception_obstacle_;
...
inline const ::atd::perception::Point& PerceptionObstacle::position() const {
...
inline ::atd::perception::Point* PerceptionObstacle::mutable_position() {
  set_has_position();
  if (position_ == NULL) {
...
inline ::atd::perception::Point* PerceptionObstacle::release_position() {
...
inline void PerceptionObstacle::set_allocated_position(::atd::perception::Point* position) {
  delete position_;
  position_ = position;
  if (position) {
    set_has_position();
...
inline const ::atd::perception::Point& PerceptionObstacle::velocity() const {
  // @@protoc_insertion_point(field_get:atd.perception.PerceptionObstacle.velocity)
  return velocity_ != NULL ? *velocity_
                         : *::atd::perception::Point::internal_default_instance();
}
inline ::atd::perception::Point* PerceptionObstacle::mutable_velocity() {
  set_has_velocity();
  if (velocity_ == NULL) {
...
inline ::atd::perception::Point* PerceptionObstacle::release_velocity() {
...
inline void PerceptionObstacle::set_allocated_velocity(::atd::perception::Point* velocity) {
  delete velocity_;
  velocity_ = velocity;
  if (velocity) {
    set_has_velocity();
...
inline const ::google::protobuf::RepeatedPtrField< ::atd::perception::Point >&
...
inline ::atd::perception::PerceptionObstacle_Type PerceptionObstacle::type() const {
...
inline void PerceptionObstacle::set_type(::atd::perception::PerceptionObstacle_Type value) {
...
inline ::atd::perception::PerceptionObstacle_ConfidenceType PerceptionObstacle::confidence_type() const {
...
inline void PerceptionObstacle::set_confidence_type(::atd::perception::PerceptionObstacle_ConfidenceType value) {
...
inline const ::atd::perception::PerceptionObstacle& PerceptionObstacles::perception_obstacle(int index) const {
...
inline ::atd::perception::PerceptionObstacle* PerceptionObstacles::mutable_perception_obstacle(int index) {
...
inline ::atd::perception::PerceptionObstacle* PerceptionObstacles::add_perception_obstacle() {
  // @@protoc_insertion_point(field_add:atd.perception.PerceptionObstacles.perception_obstacle)
  return perception_obstacle_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::atd::perception::PerceptionObstacle >*
...
inline const ::google::protobuf::RepeatedPtrField< ::atd::perception::PerceptionObstacle >&
...
inline const ::atd::common::Header& PerceptionObstacles::header() const {
...
inline ::atd::common::Header* PerceptionObstacles::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
inline ::atd::common::Header* PerceptionObstacles::release_header() {
...
inline void PerceptionObstacles::set_allocated_header(::atd::common::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline ::atd::common::ErrorCode PerceptionObstacles::error_code() const {
...
inline void PerceptionObstacles::set_error_code(::atd::common::ErrorCode value) {
...
template <> struct is_proto_enum< ::atd::perception::PerceptionObstacle_Type> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::atd::perception::PerceptionObstacle_ConfidenceType> : ::google::protobuf::internal::true_type {};
...
#endif  // PROTOBUF_modules_2fipc_2fmessage_2fprotobuf_2fperception_2fperception_5fobstacle_2eproto__INCLUDED
