...
#include "modules/common/include/util/3rd/stringprintf.h"
#include "modules/common/include/util/3rd/strutil.h"
#include "modules/common/include/util/3rd/mathlimits.h"
 ...
 *   //output << PrintIter(vec);
 *   //output << PrintIter(vec, ",");
 *   //output << PrintIter(vec.begin(), vec.end());
 *   //output << PrintIter(vec.begin(), vec.end(), "|");
 *
 *   int array[] = {1, 2, 3};
 *   //output << PrintIter(array);
 *   //output << PrintIter(array, "|");
 *   //output << PrintIter(array + 0, array + 10, "|");
 */
